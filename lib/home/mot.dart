...
void main() => runApp(const CodeValidationApp());

class CodeValidationApp extends StatelessWidget {
  const CodeValidationApp({super.key});
...
class _CodeEntryScreenState extends State<CodeEntryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Validation du code',style: TextStyle(
          color: Colors.white,
          fontSize: 40,
        ),textAlign: TextAlign.center,),backgroundColor: Colors.blue,
      ),
      body: Center(
        child: Padding(
